				 ...
				 if(candle_fire_9==0x01)
				 {
				    ...
				    right_dis= Ultrasonic_Get_Right();//右侧检查
					  ...
					  //now position is middle gate of room 1,and next action turn left 
						...
						while(front_dis > 210);//改为20-5.19，23-5.20   230  250    230  210合适
						delay_ms(50);//-------------------
...
//								find_fire_turn_back_left();
		...
		////////////////////							
					...
					//----------------------------------	
						...
						while(front_dis > 179);//18cm，230-5.20    3.23-260    180合适   175稍微有点紧
...
///////////////
	...
	//							find_fire_turn_back_right();
							...
							else //---------------无3--
							{
								...
								{
									Circulation_wall_right();
								}while(front_dis >185);  //180可以走 稍微远    改  170太近了  -------------------改  3.24  175  178有点近   180可但还需要调节
								car_stop();
