...
void forward()
{
	adjustDirection_1(1590,1415);//原1700，1300
}
void turn_left_90()
{
	adjustDirection_1(1350,1350);
	delay_ms(460);//延时500ms即可 ——原数据360改为540——5.18，400-5.19，420-5.20
}
...
void turn_right_90()
{
	...
	delay_ms(470);//延时500ms即可 ——原数据360改为540——5.18，400-5.19，420-5.20 460-10.21
}

void turn_right_90_small()
{
	adjustDirection_1(1650,1650);
	delay_ms(380);//延时500ms即可 ——原数据360改为540——5.18，400-5.19，420-5.20
}
...
void turn_right_180()
{
	...
	delay_ms(900);//延时500ms即可 ——原数据950，改为延迟1080-5.17，1060-5.18，840-5.20，880-5.26      840不行   500不行    300不行   延时1000角度开始接近    1140不行  980 1050不行  860  880  950   1020  1065  1085 1150
...
//--------------------小车离墙距离小于172mm
/////////////////////////	
	  else if(left_dis <=140)//turn right
	 {
		 error_dis=(140-left_dis)*kp_dis;
/////////////////////////////
//小车离中心线大于50mm，只有位置环pid，没有方向环pid
/////////////////////////			 
		 if(140-left_dis>50)
