...
void lcd_init(void)
{
    ...
    /* FMC读时序控制寄存器 */
    fmc_read_handle.AddressSetupTime = 0x0F;          /* 地址建立时间(ADDSET)为15个HCLK 1/180M*15=5.5*15=82.5ns */
    fmc_read_handle.AddressHoldTime = 0x00;
    fmc_read_handle.DataSetupTime = 0x46;             /* 数据保存时间(DATAST)为70个HCLK =5.5*70=385ns */
    ...
    fmc_write_handle.DataSetupTime = 0x0F;            /* 数据保存时间(DATAST)为5.5ns*15个HCLK=82.5ns */
