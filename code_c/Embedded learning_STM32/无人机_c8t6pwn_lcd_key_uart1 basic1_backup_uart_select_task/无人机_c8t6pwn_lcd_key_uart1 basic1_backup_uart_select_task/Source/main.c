...
//					{
//						rx_end_flag=0;
//						if(command_text==0x00)
//						{
//								
//								led0pwmval=1500;//high mean low speed
//								TIM_SetCompare1(TIM3,led0pwmval);
//							//停止
//								OLED_Show16x16(16+16*4,4,87,0);
//								OLED_Show16x16(16+16*5,4,88,0);
//						}
//						else if(command_text==01)
//						{
//							//吊篮下降
//								led0pwmval=1300;//high mean low speed
//								TIM_SetCompare1(TIM3,led0pwmval);
//							
//								stop_time=0x00;
//							
//								done_flag=0x01;
//								OLED_Show16x16(16+16*4,4,91,0);
//								OLED_Show16x16(16+16*5,4,92,0);
//							
//							
//							
//						}
//						else if(command_text==02)
//						{
//							//吊篮上升
//								led0pwmval=1500+200;//high mean low speed
//								TIM_SetCompare1(TIM3,led0pwmval);
//							
//								stop_time=0x00;
//							
//								done_flag=0x01;
//								//上升
//								OLED_Show16x16(16+16*4,4,89,0);
//								OLED_Show16x16(16+16*5,4,90,0);
//							
//						}
//								
//						}
//					else if(done_flag==0x01)
//					{
//						if(stop_time>=2900)
//						{
//							done_flag=0x00;
